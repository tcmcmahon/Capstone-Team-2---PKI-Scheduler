...
export default function AlgoResult(){
    return <div>
               <body style={{backgroundImage: `url(${img2})`, backgroundRepeat: "repeat-y", backgroundPosition: "top"}}>
                ...
                <h3 style={{textAlign: "center", margin: "auto", backgroundColor: "black", color: "white", width: "70%"}}><pre>{algoResult}</pre></h3>
                </body>
            </div>
}